...
#define GPIO_PORT_IIC     GPIO_PORT_P3                       /* GPIO端口 */

#define IIC_SCL_PIN       GPIO_PIN1                  /* 连接到SCL时钟线的GPIO */
#define IIC_SDA_PIN       GPIO_PIN0                  /* 连接到SDA数据线的GPIO */

/* 定义读写SCL和SDA的宏，已增加代码的可移植性和可阅读性 */
#if 1	/* 条件编译： 1 选择GPIO的库函数实现IO读写 */
#define IIC_SCL_1()  GPIO_setOutputHighOnPin(GPIO_PORT_IIC,IIC_SCL_PIN)		/* SCL = 1 */
#define IIC_SCL_0()  GPIO_setOutputLowOnPin(GPIO_PORT_IIC,IIC_SCL_PIN)		/* SCL = 0 */

#define IIC_SDA_1()  GPIO_setOutputHighOnPin(GPIO_PORT_IIC,IIC_SDA_PIN)		/* SDA = 1 */
#define IIC_SDA_0()  GPIO_setOutputLowOnPin(GPIO_PORT_IIC,IIC_SDA_PIN)		/* SDA = 0 */

#define IIC_SDA_READ()  GPIO_getInputPinValue (GPIO_PORT_IIC, IIC_SDA_PIN)	/* 读SDA口线状态 */
...
//    HAL_GPIO_Init(GPIO_PORT_IIC, &GPIO_InitStructure);
    ...
    GPIO_setAsOutputPin(GPIO_PORT_IIC,IIC_SCL_PIN);//设置输出模式
    GPIO_setAsOutputPin(GPIO_PORT_IIC,IIC_SDA_PIN);
